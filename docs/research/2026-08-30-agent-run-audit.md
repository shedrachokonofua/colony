...
- It captures only the _latest_ tree — no temporal history, no command chronology, no causality. "State at minute 47" still requires explicit snapshots.
